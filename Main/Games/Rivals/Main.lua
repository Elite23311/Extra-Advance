...
-- Rivals: anti-cheat bypass + unlock-all (runs before UI).
-- Credits: github.com/swish-hub/rivals-ac (BETA) + original unlock block.
...
-- Universal/Main sets getgenv().Tabs; Rivals-only route does not, so define tabs here.
